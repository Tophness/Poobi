...
from resolveurl.lib.net import (
    Net, get_ua,
    FF_USER_AGENT, FF_LINUX_USER_AGENT, FF_ANDROID_USER_AGENT, FF_MAC_USER_AGENT, FF_IOS_USER_AGENT, FF_IPAD_USER_AGENT,
    OPERA_USER_AGENT, OPERA_MAC_USER_AGENT, OPERA_LINUX_USER_AGENT,
    IOS_USER_AGENT, IPAD_USER_AGENT, ANDROID_USER_AGENT,
    EDGE_USER_AGENT, EDGE_MAC_USER_AGENT,
    CHROME_USER_AGENT, CHROME_LINUX_USER_AGENT, CHROME_ANDROID_USER_AGENT, CHROME_MAC_USER_AGENT, CHROME_IOS_USER_AGENT,
    SAFARI_USER_AGENT, IE_USER_AGENT
)
