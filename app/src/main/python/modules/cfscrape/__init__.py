...
class CloudScraper(Session):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.min_request_interval = kwargs.pop('min_request_interval', 0.2)  # Reduced delay
        self.max_concurrent_requests = kwargs.pop('max_concurrent_requests', 20)  # Support recursive challenges
    ...
    def _refresh_session(self, url):
        ...
        try:
            ...
            try:
                ...
                # CRITICAL: Use perform_request to avoid infinite recursion with self.request
                test_response = self.perform_request('GET', base_url, timeout=30)
